// AdminDashboard.js med sekundær Firebase-app og korrekt import
...
function AdminDashboard() {
  ...
  const leggTilBruker = async () => {
    ...
    try {
      const brukerCredential = await createUserWithEmailAndPassword(secondaryAuth, nyEpost, passord);
